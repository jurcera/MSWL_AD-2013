...
public class HEmet_hist_eact extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hemet_hist_eact);
		
		// initialize our XYPlot reference:
		mySimpleXYPlot = (XYPlot) findViewById(R.id.mySimpleXYPlotHistEact);
		...
		printGraph(" -- " + getString(R.string.label_act) + " - " + getString(R.string.label_dayly) + " -- " , dayValues, getString(R.string.label_time),getString(R.string.unit_kWath));
		
		Button bt1 = (Button) this.findViewById(R.id.btHistEactDay);	// Asignamos el boton1 a bt1
		if (bt1 != null)										
		{
		...
		Button bt2 = (Button) this.findViewById(R.id.btHistEactWeek);	// Asignamos el boton1 a bt1
		if (bt2 != null)										
		{
			bt2.setOnClickListener(new OnClickListener() { 		// Crea un listener para en boton1 	
				...
				public void onClick(View v) {					// Llama a actividad1 al pulsar boton1
					...
					printGraph(getString(R.string.label_act) + " - " + getString(R.string.label_weekly) , weekValues, getString(R.string.label_time),getString(R.string.unit_kWath));
		...
		Button bt3 = (Button) this.findViewById(R.id.btHistEactMonth);	// Asignamos el boton1 a bt1
		if (bt3 != null)										
		{
			bt3.setOnClickListener(new OnClickListener() { 		// Crea un listener para en boton1 	
				...
				public void onClick(View v) {					// Llama a actividad1 al pulsar boton1
					...
					printGraph(getString(R.string.label_act) + " - " + getString(R.string.label_monthly) , monthValues, getString(R.string.label_time),getString(R.string.unit_kWath));
				}
			} );
		}
		
		Button bt4 = (Button) this.findViewById(R.id.btHistEactYear);	// Asignamos el boton1 a bt1
		if (bt4 != null)										
		{
			bt4.setOnClickListener(new OnClickListener() { 		// Crea un listener para en boton1 	
				...
				public void onClick(View v) {					// Llama a actividad1 al pulsar boton1
					...
					printGraph(getString(R.string.label_act) + " - " + getString(R.string.label_yearly) , yearValues, getString(R.string.label_time),getString(R.string.unit_kWath));
				}
			} );
		}	
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.hemet_hist_eact, menu);
		return true;
	}
